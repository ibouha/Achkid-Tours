...
export default function WhatsAppButton() {
  ...
  const message = "Hello Achkid Tours! I'd love to know more about your tours and activities in Agadir.";
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-7 right-7 z-50 flex items-center justify-center w-16 h-16 bg-[#25D366] rounded-full shadow-2xl shadow-green-500/40"
    >
      {/* WhatsApp SVG icon */}
